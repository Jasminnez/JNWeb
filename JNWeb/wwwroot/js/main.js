...
var language = {
    ba: {
        ...
        Resume: "Biografija",
        Contact: "Kontakt",
        AboutMe: " Ja sam Jasmin Neziriæ, po zanimanju sam Inženjer Informacijskih Sistema i tehnologija. Roðen sam 13.11.1995. godine u Jablanici.",
        AboutMeContinue: "Trenutno živim u Jablanici, gdje sam završio osnovno obrazovanje. Srednju graðevinsku školu završavam u Mostaru, te stièem zvanje Geodetski tehnièar. Nakon srednje škole upisujem i završavam Fakultet Informacijskih tehnologija i stièem zvanje Bachelor-Inženjer Informacijskih sistema i tehnologija. Marljiv sam, vedar, struèan, savjesan, odgovoran i spreman za nove izazove i nova radna iskustva. Poznajem engleski jezik u govoru i pismu, i njemaèki jezik nivo A1.",
        h2About: "O meni",
        ...
        AboutFaculty: "Fakultetsko obrazovanje mi je dalo širok spektar teoretskog znaja, ali i uvid u praktiène aspekte, te sam imao priliku da se upoznam sa raznim vježbama, projektima, programima, programskim jezicima koje sam imao priliku raditi na fakultetu.",
        HighSchoolDegree: "Geodetski tehnièar",
        HighSchoolAbout: "Po završetku Srednje graðevinske škole stièem zvanje Geodetski tehnièar",
        HighSchool: "Srednja graðevinska škola",
